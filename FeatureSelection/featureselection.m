...
featnames = {...
    'For the sentimentalist in you',...
    'Low bduget camp of horror'...
    'Epic action adventure!',...
    'Complicated, dark and thrilling',...
    'Lots of laughs at societies expense',...
    'Prepare to be disturbed',...
    'Foreign cinema snobs only',...
    'Relationships and the unknown world',...
    'Provocative alternative dystopias',...
    'Grounded in reality'...
    };
